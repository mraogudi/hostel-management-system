...
@Entity
@Table(name = "personal_details_update_requests")
public class PersonalDetailsUpdateRequest {
    ...
    @Column(name = "warden_comments", columnDefinition = "TEXT")
    ...
    public PersonalDetailsUpdateRequest(Long studentId, String studentName, String studentRollNo) {
        this();
